		...
		while (myBoard.getGameEnded() == false)
		{
			...
			for (ClientHandler mc : Server.playerVector) {
				...
				if (currentlyCheckingClientNo == myBoard.getWhoIsPlaying()) {
					...
					System.out.println();
					///////////////////////////////////////////////////////////////////////////////////
					ArrayList<String> myHand = myBoard.getHandOf(myBoard.getWhoIsPlaying());
                	
                	int[] myColorCount = {0, 0, 0, 0};
                	
                	for (int i = 0 ; i < 4 ; i++)
                		myColorCount[i] =  Client.cardsCounterOfColor(myBoard, myBoard.getWhoIsPlaying(), myBoard.getColors(i));
